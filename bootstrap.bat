...
if exist ".\tools\build\src\engine\bin.ntx86_64.debug\bjam.exe" (
   copy .\tools\build\src\engine\bin.ntx86_64.debug\b2.exe . > nul
   copy .\tools\build\src\engine\bin.ntx86_64.debug\bjam.exe . > nul
   goto :bjam_built)
